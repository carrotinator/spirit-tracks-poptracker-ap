...
local railDict = {
	...
	["woodlandtracks"] = {"wtt", "w_castle", "w_wt", "forest_glyph"},
	...
	["dunetracks"] = {"dtt", "desert", "sand_shortcut", "sand_source"},
	...
	["anoukivillagetracks"] = {"w_wt", "snow_bridge", "snow_glyph"},
	["castletracks"] = {"n_castle", "forest_source", "forest_glyph"},
	["aridtracks"] = {"ocean_portal", "desert", "sand_shortcut", "fire_source", "sand_source"},
	["towertracks"] = {"forest_source", "snow_source", "ocean_source", "fire_source"},

	["completedforestglyph"] = {"wtt", "ocean_shortcut", "mayscore_bridge", "tp_portal", "w_castle", "w_forest", "cave", "w_wt", "n_castle", "snow_bridge", "forest_source", "forest_glyph"},
	["completedsnowglyph"] = {"btt", "snowdrift", "slippery", "w_wt", "n_castle", "snow_bridge", "nicyspring", "gorge", "snow_source", "snow_glyph"},
	...
	["completeddeserttracks"] = {"dtt", "desert", "sand_shortcut", "dom", "sand_source"},

	["majorforesttracks"] = {"wtt", "forest_source", "forest_glyph"},
	["majorsnowtracks"] = {"btt", "snow_source", "snow_glyph"},
	["majorfiretracks"] = {"fire_glyph", "mtt", "fire_source"},
	["majoroceantracks"] = {"ocean_glyph", "oct", "ocean_source"},
	["majordeserttracks"] = {"dtt", "desert", "sand_source"},
...
local reverseRailDict = {
	...
	["pirate"] = {"islandtracks", "piratetracks", "completedoceanglyph", "minoroceantracks"},
	["ocean_shortcut"] = {"coastaltracks", "piratetracks", "completedforestglyph", "completedoceanglyph", "minorforesttracks", "minoroceantracks"},
	["disorientation"] = {"valleytracks", "completedfireglyph", "minorfiretracks"},
	["w_castle"] = {"woodlandtracks", "completedforestglyph", "minorforesttracks"},
	["snowdrift"] = {"blizzardtracks", "completedsnowglyph", "minorsnowtracks"},
	["n_castle"] = {"thawlandtracks", "borderlandstracks", "castletracks", "completedforestglyph", "completedsnowglyph", "minorforesttracks", "minorsnowtracks"},
	["las"] = {"islandtracks", "oceantracks", "completedoceanglyph", "minoroceantracks"},
	["dtt"] = {"mountaintracks", "dunetracks", "completeddeserttracks", "majordeserttracks"},
	["desert"] = {"dunetracks", "aridtracks", "completeddeserttracks", "majordeserttracks"},
	["cave"] = {"westernforesttracks", "completedforestglyph", "minorforesttracks"},
	["snow_bridge"] = {"borderlandstracks", "anoukivillagetracks", "completedforestglyph", "completedsnowglyph", "minorforesttracks", "minorsnowtracks"},
	["forest_source"] = {"castletracks", "towertracks", "majorforesttracks", "completedforestglyph"},
	["snow_source"] = {"blizzardtracks", "thawlandtracks", "towertracks", "completedsnowglyph", "majorsnowtracks"},
	["oct"] = {"oceantracks", "completedoceanglyph", "majoroceantracks"},
	["mtt"] = {"mountaintracks", "completedfireglyph", "majorfiretracks"},
	["mayscore_bridge"] = {"coastaltracks", "completedforestglyph", "minorforesttracks"},
	["slippery"] = {"blizzardtracks", "completedsnowglyph", "minorsnowtracks"},
	["dom"] = {"mountaintracks", "completedfireglyph", "completeddeserttracks", "minorfiretracks", "minordeserttracks"},
	["gorge"] = {"valleytracks", "thawlandtracks", "completedsnowglyph", "completedfireglyph", "minorsnowtracks", "minorfiretracks"},
	["w_wt"] = {"woodlandtracks", "westernforesttracks", "borderlandstracks", "anoukivillagetracks", "completedforestglyph", "completedsnowglyph", "minorforesttracks", "minorsnowtracks"},
	["nicyspring"] = {"thawlandtracks", "completedsnowglyph", "minorsnowtracks"},
	["ocean_portal"] = {"oceantracks", "piratetracks", "aridtracks", "completedoceanglyph", "minoroceantracks"},
	["sand_shortcut"] = {"dunetracks", "aridtracks", "completedfireglyph", "completeddeserttracks", "minorfiretracks", "minordeserttracks"},
	["snow_glyph"] = {"anoukivillagetracks", "completedsnowglyph", "majorsnowtracks"},
	["forest_glyph"] = {"woodlandtracks", "castletracks", "majorforesttracks", "completedforestglyph"},
	["ocean_source"] = {"oceantracks", "towertracks", "completedoceanglyph", "majoroceantracks"},
	["fire_source"] = {"aridtracks", "towertracks", "completedfireglyph", "majorfiretracks"},
	["sand_source"] = {"dunetracks", "aridtracks", "completeddeserttracks", "majordeserttracks"},
	["tp_portal"] = {"coastaltracks", "completedforestglyph", "minorforesttracks"},
	["eote"] = {"mountaintracks", "completedfireglyph", "minorfiretracks"},
	["w_forest"] = {"westernforesttracks", "completedforestglyph", "minorforesttracks"}
}
...
ListItemWatches(CannonPortalSweep, {"cannon", "portal_tracks", "portal_behavior"})